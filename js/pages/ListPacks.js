      ...
      <template v-else>
          ...
          <table class="list" v-if="selectedPackLevels && selectedPackLevels.length">
            <tr v-for="(level, i) in selectedPackLevels">
              ...
              <td class="level" :class="{ 'active': selectedLevel == i, 'error': !level || !level[0] }">
                <button
                  :style="selectedLevel === i && pack ? { background: pack.colour } : {}"
        ...
        <div class="meta-container">
          <div class="meta">
            ...
            <p>
              These are list packs chosen by the staff team. Beat every level in a pack to earn it on your profile.
            </p>
            <h3>How can I get these packs?</h3>
            <p>
              Beat the levels and get your records added — the packs automatically appear once all levels are completed.
            </p>
          </div>
        </div>
      </template>
